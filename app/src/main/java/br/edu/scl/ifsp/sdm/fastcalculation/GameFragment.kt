...
class GameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentGameBinding.apply {
            ...
            alternativeFiveBt.setOnClickListener(onClickListener)
        }
        play()
    ...
    private fun play() {
        ...
        if (currentRound != null) {
            fragmentGameBinding.apply {
                ...
                alternativeThreeBt.text = currentRound!!.alt2.toString()
                alternativeFiveBt.text = currentRound!!.alt3.toString()
            }
            ...
            childFragmentManager.beginTransaction()
                .replace(R.id.gameFl, ResultFragment.newInstance(settings, "%.1f".format(points))).commit()
        }
    }
}